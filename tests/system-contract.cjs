...
(async()=>{
 ...
 const beforeCandidate='C:/SillyTavern-1.18.0/SillyTavern-1.18.0/data/default-user/st-direct-validation/before-system-redesign/index.js';
 if (fs.existsSync(beforeCandidate)) {
   const before=fs.readFileSync(beforeCandidate,'utf8');
